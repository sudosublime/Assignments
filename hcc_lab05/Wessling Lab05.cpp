...
int main()
{
   ...
   /*4. This process of allowing the user to select an item and your program 
        displaying the subtotal should continue until the user enters exit when
        prompted for the item he / she wants to purchase.*/

   do
   {
   // 1. User Input(5 points)
      // a.Your program should first ask the user what item he / she wants to purchase. 
      // b.If the user indicates a notebook, pen, or pencil, ask the user how many of the item he/she 
      //   wants to buy. Make sure that the input is a positive number before proceeding.
      ...
      /*6. You can assume that the user will type in his/her input choice 
           using one of the following : (3 points)
      ...
      if (typeChoice == "Notebook" || typeChoice == "NOTEBOOK" || typeChoice == "notebook")
      {
         ...
         //  1b.If the user indicates a notebook, pen, or pencil, ask the user 
         //  how many of the item he / she wants to buy. Make sure that the 
         //  input is a positive number before proceeding.
         if (notebookNumber < 0)
         {
      ...
      // Check if typeChoice is Pencil, PENCIL, pencil
      else if (typeChoice == "Pencil" || typeChoice == "PENCIL" || typeChoice == "pencil")
      {
         cout << "How many Pencils? (zero to start over)\n";
         cin >> pencilNumber;

         // Check if number of pencils is greater than 0 but less than 5
         if (pencilNumber > 0 && pencilNumber < 5)
         {
            // Pencil subtotal
            totalPencilBalance = (PENCIL_PRICE_1 * pencilNumber);
            cout << "The subtotal for the Pencils is $" << setprecision(2) 
                 << fixed << totalPencilBalance << endl << endl;
         }
         // Check if pencilNumber is greater than 5 but less than 10
         ...
         // Check if pencilNumber is negative
         ...
         {
            // Pencil Subtotal for anything over 10
...
{
cout << "Error! The subtotal for the calculator is: $0.00 " << endl;
}
